...
void populateMenu(vector<MenuItem> &entireMenu)
{
  ...
  vector<string> defaultMenuNames = {"Green Tea", "Burrito", "Tamale", "Horchata", "Burger", "Wings", "Turkey Leg"}; 
  ...
  for(int i = 0; i < numItems; i++)
  {
    ...
    //The above code could be added while the bottom code is removed
  }
    entireMenu[0].desc = "Calming";
    entireMenu[1].desc = " Rice, Beans,and meat";
    entireMenu[2].desc = " Green chicken or Red Pork";
    entireMenu[3].desc = " Rice drink";
    entireMenu[4].desc = " Lettuce, tomates, and onions";
    entireMenu[5].desc = " BBQ, Mild, or Spicy";
    entireMenu[6].desc = " Savory Turkey leg";
...
void acceptOrder(vector<MenuItem> &m)
{
  ...
  cout << "Subtotal is:$" << subtotal << endl << endl ;
  ...
  {
  cout << "How much tip would you like to leave? Suggested amount 20%" << endl;
  cin>>percent;
  cout << "You have put a %" << percent << " tip"<< endl;
  cout << "Total with tip:$" << ((percent/100)+1)*subtotal*1.08<<endl;//some reason its not working
  ...
  {
  cout << "How would you like to pay?" << endl;
  cout << "Total:$" << subtotal*1.08 << endl;
  j=j+1;
  }
  else
  {
    cout << "invalid imput. Please put a valid responce" << endl;
  }
  }

cout <<"Please choose between Cash or Credit.\nA.Cash\nB.Credit\n" <<endl;
    for (int j = 0; j<1;)
    {
      string choice1;
      int money;
  ...
  {
    cout << "Please give appropriate amount:$" << endl;
    cin>>money;
    cout << "Your change is $" << money-subtotal*1.08 <<endl << "All clear. Thank you, come again.";
  }
    else if(choice1 == "b" || choice1 == "B")
    {
    cout << "Please enter your card into the system.\n...\n..\nAll clear. Thank you, come again.";
    }
    else
    {
